...
function LoadUpdateInfos(){
	$DE('updateinfos').innerHTML = "<div style=\"height:90px;\"><img src='data/images/loadinglit.gif' /> 正在处理中...</div>";
...
function SkipReload(nnum){
    ...
    {
        DedeXHTTP = null;
        $DE('updateinfos').innerHTML = "<img src='data/images/loadinglit.gif' /> 正在处理中...";
        var myajax = new DedeAjax($DE('updateinfos'));
